...
export const en: Dictionary = {
  ...
  home: {
    ...
    console: {
      ...
      scopeUnknown: 'The other {n} publish none — mostly sole traders, dormant entities and foreign branches.',
      scopeInBand: 'entities in the {band} band.',
      scopeIcp: '{n} sit in the 5–49 band the design partnership targets — before executive search is confirmed firm by firm.',
      streamLabel: 'Evidence ledger · newest first',
      streamCount: '{n} sources',
